...
function Glance() {
  return (
    <div className="">
      <div className="relative overflow-hidden py-[48px] px-[2rem] gap-[24px] flex flex-col md:flex-row md:gap-[96px] items-center md:items-start justify-center md:py-[96px] md:px-[96px] bg-background-page">
        <div className="flex items-start gap-5  flex-col max-w-[560px]">
        ...
        <div className="max-w-[592px] md:w-[100%] flex items-center justify-center rounded-[16px] bg-highlight select-none p-[16px]">
