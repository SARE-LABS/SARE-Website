    ...
    >
        <div className="h-max flex justify-between items-center md:px-0 px-4 py-4 gap-4">
            <div className="md:w-[120px] w-[140px] h-[80px] md:h-[120px] relative">
                <Image alt="S.A.R.E. is Cooking" src={SARE} className="object-cover w-full h-full absolute top-0 rounded-lg rotate-[-8deg] shadow-2xl" />
                <Image  src={SARE} alt="S.A.R.E. is Cooking" className="object-cover w-full h-full absolute top-0 rounded-lg" />
            </div>
