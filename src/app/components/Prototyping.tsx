      ...
      >
        ...
        >
          <span className="w-fit flex-shrink-0 whitespace-nowrap  flex items-center text-primary-blue rounded-[24px] px-[16px] py-[8px] transition-all ease-in-out duration-200 bg-highlight gap-3">
            ...
            <p>Prototyping & Building</p>
          </span>
          <h1 className="text-[36px] text-text-primary font-medium  leading-[120%]">
            We Turn concepts into robots that work
          </h1>
          <p className="text-[16px] text-text-primary leading-[148%]">
            This is where ideas come to life. We design and build functional
            prototypes using advanced robotics and IoT technologies. From
            irrigation bots to automated harvesters, every prototype goes
            through iterative improvements to ensure efficiency and durability.
          </p>
          <motion.div
            variants={containerVariants}
