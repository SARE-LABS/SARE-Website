...
function CardLarge() {
  return (
    <div className="relative w-full h-[160px]  rounded-ful">
      ...
      <div className="relative w-[100%] h-[160px] md:h-full rounded-2xl   overflow-hidden  flex justify-items-end items-end ">
        <Image
          src={Kennedy}
        ...
        <div className="relative inset-0 flex flex-col justify-between -4">
          <div className="flex flex-col items-center justify-center">
            <p className="text-white p-3  text-left text-sm leading-[148%]">
              Interviewing farmers at Egundungun lagos about a new type of farm
